...
func init() {
	authCmd.Flags().StringVar(&twitchClientID, "twitch-client-id", "j1i10vfts1iy5p43v8pipr6brg2u3q", "Twitch.tv application client ID received at https://dev.twitch.tv")
